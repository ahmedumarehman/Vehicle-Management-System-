...
class information
{
   ...
   information(string naam,string fn,string dob,int a,string C,string nation,string stat):
   name(naam),fathername(fn),DOB(dob),age(a),CNIC(C),nationality(nation),status(stat) // parameter constructor
   {
...
int main()
{
    ...
    cout<<"Let's Get You Started ! ! ! "<<endl<<endl;
    ...
    if(option==1) // if user selects sign up option
    {
        ...
        cout<<"\n\nYou Made Your Account ! ! !"<<endl<<endl;
