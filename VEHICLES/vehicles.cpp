...
{
    cout<<"Contact Information\n\n";
    cout<<"Buyer's Name     : "<<sellername<<endl;
    cout<<"Buyer's Contact  : "<<contact<<endl;
}
    ...
    if (options_to_view_vehicles == 1)   // used car
    {
        ...
        if (usedcar_options == 1) // condition for selecting BMW Vehicle it will stor in a file
        {
            ...
            cin>>option_for_inspection_report_BMW;
                ...
                char option_to_view_notifications;
                cout<<"Want To View Notification Of BMW (y/n) : ";
                cin>>option_to_view_notifications;

                if(option_to_view_notifications=='y'||option_to_view_notifications=='Y')
                {   
                    cout<<"\t\tINFORMATION OF BMW\n\n";
                    bmw.notification();
                }

                //ofstream notificationfile;
                //notificationfile.open("Notification_BMW.txt",ios::out);
                //notificationfile<<bmw.notification()<<endl;
        ...
        else if (usedcar_options == 2)  // condition for selecting Suzuki Vehicle it will stor in a file
        {
            ...
            cin>>option_for_inspection_report_suzuki;
                ...
                else 
                {
                 ...
                 char option_to_view_notifications;
                cout<<"Want To View Notification Of Suzuki (y/n) : ";
                cin>>option_to_view_notifications;

                if(option_to_view_notifications=='y'||option_to_view_notifications=='Y')
                {   
                    cout<<"\t\tINFORMATION OF Suzuki\n\n";
                    suzuki.notification();
                }
        ...
        else if(usedcar_options == 3) // condition for selecting toyota vehicle it will sotre in a file
        {
            ...
            cin>>option_for_inspection_report_toyota;
                ...
                else
                {
                 ...
                 char option_to_view_notifications;
                cout<<"Want To View Notification Of Toyota (y/n) : ";
                cin>>option_to_view_notifications;

                if(option_to_view_notifications=='y'||option_to_view_notifications=='Y')
                {   
                    cout<<"\t\tINFORMATION OF TOYOTA\n\n";
                    toyota.notification();
                }
    ...
    {   
        ...
        if(newcar_option==1) // condition if user selects GMC vehicle
        {
            ...
            cin>>option_for_inspection_report_GMC;
                ...
                else
                {
                 ...
                 char option_to_view_notifications;
                cout<<"Want To View Notification Of GMC (y/n) : ";
                cin>>option_to_view_notifications;
        ...
        else if(newcar_option==2) // condition if user selects FORD vehicle
        {
            ...
            cin>>option_for_inspection_report_FORD;
                ...
                char option_to_view_notifications;
                cout<<"Want To View Notification Of FORD (y/n) : ";
                cin>>option_to_view_notifications;
        ...
        if(newcar_option==3) // condition if user selects FERRARI vehicle
        {
            ...
            cin>>option_for_inspection_report_FERRARI;
                ...
                else
                {
                 ...
                 char option_to_view_notifications;
                cout<<"Want To View Notification Of FERRARI (y/n) : ";
                cin>>option_to_view_notifications;

                if(option_to_view_notifications=='y'||option_to_view_notifications=='Y')
                {   
                    cout<<"\t\tINFORMATION OF FERRARI\n\n";
        ...
        if(bikes_option==1) // condition if user selects HONDA and then stores in a file
        {
            ...
            cin>>option_for_inspection_report_HONDA;
                ...
                else
                {
                 ...
                 char option_to_view_notifications;
                cout<<"Want To View Notification Of HONDA (y/n) : ";
                cin>>option_to_view_notifications;

                if(option_to_view_notifications=='y'||option_to_view_notifications=='Y')
                {   
                    cout<<"\t\tINFORMATION OF HONDA\n\n";
                    HONDA.notification();
                }
         ...
         else // condition if user selects Yamaha and then stores in a file
        {
            ...
            cin>>option_for_inspection_report_YAMAHA;
                ...
                else
                {
                 ...
                 char option_to_view_notifications;
                cout<<"Want To View Notification Of YAMAHA (y/n) : ";
                cin>>option_to_view_notifications;

                if(option_to_view_notifications=='y'||option_to_view_notifications=='Y')
                {   
                    cout<<"\t\tINFORMATION OF YAMAHA\n\n";
                    YAMAHA.notification();
                }
    ...
    {   
        ...
        {   
            ...
            cin>>option_for_inspection_report_KIA;
                ...
                char option_to_view_notifications;
                cout<<"Want To View Notification Of KIA (y/n) : ";
                cin>>option_to_view_notifications;

                if(option_to_view_notifications=='y'||option_to_view_notifications=='Y')
                {   
                    cout<<"\t\tINFORMATION OF KIA\n\n";
                    KIA.notification();
                }
        ...
        else if(option_auction==2) // condition of new cars if user selected
        {
            ...
            cin>>option_for_inspection_report_PORSCHE;
                ...
                char option_to_view_notifications;
                cout<<"Want To View Notification Of PORSCHE (y/n) : ";
                cin>>option_to_view_notifications;

                if(option_to_view_notifications=='y'||option_to_view_notifications=='Y')
                {   
                    cout<<"\t\tINFORMATION OF PORSCHE\n\n";
                    PORSCHE.notification();
                }
            ...
            cin>>option_for_inspection_report_MERCEDES;
                ...
                char option_to_view_notifications;
                cout<<"Want To View Notification Of MERCEDES (y/n) : ";
                cin>>option_to_view_notifications;

                if(option_to_view_notifications=='y'||option_to_view_notifications=='Y')
                {   
                    cout<<"\t\tINFORMATION OF MERCEDES\n\n";
                    MERCEDES.notification();
                }
        ...
        {   
            ...
            cin>>option_for_inspection_report_KAWASAKI;
                ...
                char option_to_view_notifications;
                cout<<"Want To View Notification Of KAWASAKI (y/n) : ";
                cin>>option_to_view_notifications;

                if(option_to_view_notifications=='y'||option_to_view_notifications=='Y')
                {   
                    cout<<"\t\tINFORMATION OF KAWASAKI\n\n";
                    KAWASAKI.notification();
                }
            ...
            cin>>option_for_inspection_report_TESLA;
                ...
                char option_to_view_notifications;
                cout<<"Want To View Notification Of TESLA (y/n) : ";
                cin>>option_to_view_notifications;

                if(option_to_view_notifications=='y'||option_to_view_notifications=='Y')
                {   
                    cout<<"\t\tINFORMATION OF TESLA\n\n";
                    TESLA.notification();
                }
